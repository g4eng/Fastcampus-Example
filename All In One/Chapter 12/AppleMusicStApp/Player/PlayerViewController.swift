...
class PlayerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        timeObserver = simplePlayer.addPeriodicTimeObserver(forInterval: cmTime, queue: DispatchQueue.main, using: { time in
    ...
    @IBAction func seek(_ sender: UISlider) {
        // TODO: 시킹 구현
        guard let currentItme = simplePlayer.currentItem else { return }
        
        let position = Double(sender.value) // 0 ... 1
        let seconds = position * currentItme.duration.seconds
